      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-primary to-accent py-24 text-white">
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-3xl text-center animate-fade-in">
            ...
            <div className="mb-8 p-6 bg-white/10 backdrop-blur-sm rounded-lg border-2 border-white/20 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="text-lg leading-relaxed italic space-y-2">
                ...
                <p className="mt-4">В Архангельске северном, на Троицком пути,</p>
                ...
                <p className="mt-4">От фантомов к клинике — путь студента лежит,</p>
