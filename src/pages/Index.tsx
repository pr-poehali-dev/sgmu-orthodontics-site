            ...
            <Card className="animate-fade-in hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Кафедра ортопедической стоматологии была основана в 1960 году на базе Архангельского государственного медицинского института.
                </p>
                <p className="text-muted-foreground mb-4">
                  За более чем 60 лет работы кафедра подготовила тысячи высококвалифицированных специалистов, которые работают не только в Архангельской области, но и по всей России и за рубежом.
                </p>
                <p className="text-muted-foreground mb-4">
                  С момента основания кафедра активно развивает научное направление, внедряя современные технологии протезирования и имплантации в учебный процесс и клиническую практику.
                </p>
                <p className="text-muted-foreground">
                  Сегодня кафедра является ведущим образовательным и научным центром ортопедической стоматологии на Северо-Западе России, оснащенным современным оборудованием и имеющим сильный преподавательский состав.
                </p>
              </CardContent>
            </Card>
